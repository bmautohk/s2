		...
		<div class="invoice_header">
			<div class="lightpanel roundedtop linkbg">
				...
				<form id="form1" method="get">
					<label class="grid_4">Invoice ID:</label><input class="grid_4" type="text" name="invoice_id" /> <div class="clear"></div>
					<label class="grid_4">Cust Cd:</label><input class="grid_4" type="text" name="cust_cd" /> <div class="clear"></div>
					<label class="grid_4">SIA Date From:</label>
						<input class="grid_4" type="text" name="settle_date_from" id="settle_date_from" />
						<input class="grid_1" type="button" id="settle_date_from_btn" value=".."/>
						<label class="grid_1" >TO:</label>
						<input class="grid_4" type="text" name="settle_date_to" id="settle_date_to" />
						<input class="grid_1" type="button" id="settle_date_to_btn" value=".."/><div class="clear"></div>
					<label class="grid_4">Settle Ref No. (Cheque No.):</label><input class="grid_4" type="text" name="cheque_no" /><div class="clear"></div>
					<label class="grid_4">Settle Amt:</label><input class="grid_4" type="text" name="amt" /><div class="clear"></div>
