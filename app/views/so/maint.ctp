                ...
                <div class="linkdescription"> 
	                <div class="container_32">
		                ...
		                <div class="grid_4"><label>Cust No.:</label></div>
		                	...
		                	<input type="button" value="Search" onclick="openWin()" />
		                <div class="clear"></div> 
...
function openWin() {
	...
	window.open('../customers/selectCust', 'selectWin', "status=1,height=" + height + ",width=" + width + ",left=" + left + ",top=" + top + ",resizable = 0");
}
</script>
