...
<?php 
echo $html->css('jquery.tooltip.css');
echo $javascript->link('jquery.tooltip.min');
$imgDir = Configure::read('productImgDir');?>
<div class="row">
	<div class="">
		<div class="po_header">
			...
			<div class="lightpanel linkbg">
				...
				<div class="linkdescription" >
					<div class="container_32">
						...
						<div class="grid_3"><a href="<?=$this->data['PoDetail'][$i]['prod_cd'] ?>" name="imgLink" onclick="return false">Photo</a></div>
						<div class="clear"></div>
						<? } ?>
...
$(function() {
	$('a[name="imgLink"]').each(function(index) {
		$(this).tooltip({ 
		    delay: 0, 
		    showURL: false, 
		    bodyHandler: function() { 
		        return $("<img/>").attr("src", "<?=$imgDir ?>" + $(this).attr("href") + ".jpg"); 
		    } 
		});
	});
});
